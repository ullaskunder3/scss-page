    ...
    <main className={styles.main}>
      ...
      <div className={styles.heroWrapper}>
        <div className={styles.imageWrapper}>
          ...
          <div style={{
            position: "absolute", bottom: "0", left: "0", width: "100%", height: "100%", backgroundImage: "linear-gradient(0deg, rgba(0, 0, 0, 0.75) 6.82%, rgba(0, 0, 0, 0.00) 81.44%)"
          }}></div>
        </div>
        <div className={styles.heroContent}>
          <div className={styles.logoGroup} style={{
            marginBottom: "40px"
          }}>
          ...
          <div className={styles.mainTextWrapper} style={{
            marginBottom: "40px",
          }}>
            <h2 style={{ marginBottom: "30px", fontWeight: "600", fontFamily: "Noto Sans", letterSpacing: "0.3em", lineHeight: "1.6", fontSize: "20px", paddingInline: "20px" }}>Lorem ipsum dolor sit amet</h2>
            <p style={{
              fontWeight: "200", fontSize: "14px", fontFamily: "Noto Sans", lineHeight: "150%", letterSpacing: "0.05em", paddingInline: "40px"
